class App {
    ...
    enrollSpaceship() {
        ...
        let crewNumber = prompt("Qual a quantidade de tripulantes?")
        let spaceshipType = this.askForSpaceshipType()
        if(spaceshipType == "1") {
            let weaponsNumber = prompt("Quantas armas a nave possui?")
            this.spaceship = new BattleSpaceship(spaceshipName, crewNumber, weaponsNumber)
        } else {
            let sitsNumber = prompt("Quantos assentos a nave possui?")
            this.spaceship = new TransportSpaceship(spaceshipName, crewNumber, sitsNumber)
        }
    }
